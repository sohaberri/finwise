...
import 'fingerprint_detail_screen.dart';
...
class _FingerprintScreenState extends State<FingerprintScreen> {
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: _fadeIn(
                      delay: 200, // Smooth slide up for the list items
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // Fingerprint List Items
                            _buildFingerprintTile(
                              icon: Icons.fingerprint, 
                              title: "John Fingerprint", 
                              iconBg: const Color(0xFF81C9CC),
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const FingerprintDetailScreen()));
                              }
                            ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text("Fingerprint", style: GoogleFonts.poppins(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w600)),
          Container(
  ...
  Widget _buildFingerprintTile({required IconData icon, required String title, required Color iconBg, VoidCallback? onTap}) {
    return InkWell(
      onTap: () {
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Text(
              title, 
              style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600, color: kTextDark)
            ),
            const Spacer(),
