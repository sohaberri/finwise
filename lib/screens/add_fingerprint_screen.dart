    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // 2. BACKGROUND BUBBLES (Elastic animation scoped to bubbles)
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text("Add Fingerprint", style: GoogleFonts.poppins(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w600)),
          Container(
