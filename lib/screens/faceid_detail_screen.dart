...
class FaceDetailScreen extends StatefulWidget {
  const FaceDetailScreen({super.key});
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // HORIZONTAL SCROLLABLE MENU ITEM
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const AddFaceidScreen()));
                              },
                              child: Row(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text("John Face", style: GoogleFonts.poppins(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w600)),
          Container(
